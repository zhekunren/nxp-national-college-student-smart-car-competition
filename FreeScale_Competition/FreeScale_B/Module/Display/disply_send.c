...
void First_Page(void)
{
	...
	Dis_Num3(0,70,Asist_Meeting_Flag,1);
...
//	UserData[0] = (int16_t)(AD[0]);
//	UserData[1] = (int16_t)(AD[1]);
//	UserData[2] = (int16_t)(AD[3]);
//	UserData[3] = (int16_t)(AD[4]);
//	UserData[4] = (int16_t)(AD[5]);
//	UserData[5] = (int16_t)(Roundabout_Asist_Flag);
//	send_user_data1(UserData);

//	OutData[0] = (int16_t)(Double_Car_Count);
//	OutData[1] = (int16_t)(Test_Tx_C);
...
//	OutData[0] = (int16_t)(AD[0]);
//	OutData[1] = (int16_t)(AD[1]);
//	OutData[2] = (int16_t)(AD[3]);
//	OutData[3] = (int16_t)(AD[4]);
	OutPut_Data();
}
