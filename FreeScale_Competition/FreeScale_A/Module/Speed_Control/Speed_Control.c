...
//	}
	...
	if(Roundabout_Asist_Flag != 0)
	{
		...
		else if(Roundabout_Asist_Flag == 7 && Left_Roundabout_Flag && (G_AD[0] > 2900 || G_AD[1] > 2800))
		{
			Change_R_Coumt++;
			if(Change_R_Coumt > 1)
			{
		...
		else if(Roundabout_Asist_Flag == 7 && Right_Roundabout_Flag && (G_AD[1] > 2900 || G_AD[0] > 2800))
		{
			Change_R_Coumt++;
			if(Change_R_Coumt > 1)
			{
		...
		else if(Roundabout_Asist_Flag == 8 && Left_Roundabout_Flag && (G_AD[3] < 2600 || (G_AD[0] < 2800 && G_AD[5] < 1800)))
		{
...
//			R_D = 0;
		...
		else if(Roundabout_Asist_Flag == 8 && Right_Roundabout_Flag && (G_AD[4] < 2600 || (G_AD[1] < 2800 && G_AD[5] < 1800)))
		{
			Roundabout_Asist_Flag = 0;
...
//	}
	...
	//if(Roundabout_Asist_Flag < 3 || Roundabout_Asist_Flag > 4)
	{
		Servo_DinaGan_Out();
...
///***************************堵转保护*************************************/	
//	if(protect_flag == 0 && Absolute(Left.Set_Speed-Left_Pulse + Right.Set_Speed - Right_Pulse) > 1800 && Absolute(Left_Pulse + Right_Pulse) < 50)
//	{
