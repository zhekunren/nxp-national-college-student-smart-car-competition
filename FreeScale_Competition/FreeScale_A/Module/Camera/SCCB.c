...
void SCCB_GPIO_Init(void)
{
  // 配置 PTA26/PTA27为GPIO功能,输出,高电平，禁用中断
    ...
    gpio_pin_config_t gpio_PTC={kGPIO_DigitalOutput,1};
    GPIO_PinInit(GPIOC,16,&gpio_PTC);
    GPIO_PinInit(GPIOC,17,&gpio_PTC);
    PORT_SetPinInterruptConfig(PORTC, 16,kPORT_InterruptOrDMADisabled);
