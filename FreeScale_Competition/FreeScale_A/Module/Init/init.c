...
void pit_init(void)
{
    ...
    PIT_SetTimerPeriod(PIT, kPIT_Chnl_0, USEC_TO_COUNT(10000, CLOCK_GetFreq(kCLOCK_BusClk)));//10ms
    ...
    EnableIRQ(PIT1_IRQn);
	//定时器3
//	PIT_SetTimerPeriod(PIT, kPIT_Chnl_3, USEC_TO_COUNT(1000U, CLOCK_GetFreq(kCLOCK_BusClk)));//1ms
