...
/*******************************************环岛处理***************************************************/
	if(Roundabout_Asist_Flag && Left_Roundabout_Flag == 0 && Right_Roundabout_Flag == 0 && PTB17_I)
	{
...
/**********************终点线检测*******************************************/
	if(Roundabout_Asist_Flag == 0 && Ramp_Flag == 0 && Left_End_Row < 58 && Right_End_Row < 58 && Ramp_Flag == 0 && 
		Meeting_Car_Flag == 0 && Asist_End_LineCount < 2 && A_End_D > 38000)// Asist_Ramp_Flag3&& Roundabout_Asist_Flag == 0
	{
...
/************************************检测车****************************************/
	if(Left_End_Row < 58 && Right_End_Row < 58 && Meeting_Car_Flag == 0 && distance_s < 1400 && PTE9_I && Double_Car_Mode &&
...
void Search_Curve_Meeting_Place(void)
{
	...
	if(Left_End_Row == 119 && ((Right_Find_Point.row - Right_End_Row < 50 && Right_Find_Point.flag && Jump_Right[Right_End_Row].column > 40) ||
		Right_Find_Point.flag == 0))//
	{
		for(column = 0;column < 160;column++)
		{
	...
	else if(Right_End_Row == 119 && ((Left_Find_Point.row - Left_End_Row < 50 && Left_Find_Point.flag && Jump_Left[Left_End_Row].column < 120) ||
		Left_Find_Point.flag == 0))//
	{
		for(column = 0;column < 160;column++)
		{
