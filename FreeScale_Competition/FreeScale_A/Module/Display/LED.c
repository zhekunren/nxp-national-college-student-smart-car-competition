...
#define LCD_SCL PTA4_O  //K60的管脚配置  D0
#define LCD_SDA	PTA5_O   //D1
#define LCD_RST PTA12_O
#define LCD_DC  PTA15_O    
#define XLevelL		0x00
#define XLevelH		0x10
...
const byte F14x16[] = {
0x00,0x00,0x7C,0x24,0x24,0xBC,0x64,0x24,0x3C,0x24,0xA4,0x7E,0x00,0x00,0x00,0x08,
0x44,0x42,0x43,0x24,0x21,0x11,0x09,0x07,0x01,0x00,0x00,0x00,/*"罗",0*/


0x00,0x80,0x90,0xA8,0x68,0xB4,0x72,0xB2,0x6C,0xA8,0xA8,0x88,0x00,0x00,0x00,0x54,
0x76,0x7D,0x55,0x3E,0x14,0x74,0x56,0x7D,0x56,0x7A,0x44,0x00
...
void Dis_Num3(byte y, byte x, int nummm,byte N) 
{
 ...
 // x=x*8;
  if(nummm>=0)
  {
  n[0]=(nummm/1000000)+16+32;
  n[1]=(nummm%1000000/100000)+16+32;
  n[2]=(nummm%1000000%100000/10000)+16+32;
  n[3]=(nummm%1000000%100000%10000/1000)+16+32;
  n[4]=(nummm%1000000%100000%10000%1000/100)+16+32;
  n[5]=(nummm%1000000%100000%10000%1000%100/10)+16+32;
  n[6]=(nummm%1000000%100000%10000%1000%100%10)+16+32;
  //n[7]=(nummm%10000000%1000000%100000%10000%1000%100%10)+16+32;
 // n[8]=46;
  //n[9]=48;
  //n[10]='\0';
  }
...
//  x=x*8;
  ...
  n[1]=(num2/100000)+16+32; 
  
  n[2]=(num2/10000 % 10)+16+32;

  n[3]=46;
	    
  n[4]=(num2/1000 % 10)+16+32;
	  
  n[5]=(num2/100%10)+16+32;
  n[6]='\0';
  }
   if(num2<0)
  {
...
void Dis_Num5(byte y, byte x, int nummm,byte N) 
{
 ...
 // x=x*8;
  ...
  {
  n[0]=43;
  n[1]=(nummm/1000000)+16+32;
  n[2]=(nummm%1000000/100000)+16+32;
  n[3]=(nummm%1000000%100000/10000)+16+32;
  n[4]=(nummm%1000000%100000%10000/1000)+16+32;
  n[5]=(nummm%1000000%100000%10000%1000/100)+16+32;
  n[6]=(nummm%1000000%100000%10000%1000%100/10)+16+32;
  //n[7]=(nummm%1000000%100000%10000%1000%100%10)+16+32;
//  n[7]=(nummm%10000000%1000000%100000%10000%1000%100%10)+16+32;
 // n[8]=46;
  //n[9]=48;
  //n[10]='\0';
