...
/*********************单双车停车控制**************************/	
	if(End_Line_Flag || Pro_End_Line_Flag)
	{
...
/*****************************弯道会车区********************************************/	
	if(RX_TAB_s[4] & 0x01 && CurMeetingPlace_flag && Cur_M_A_f && RX_TAB_s[4] & 0x08)
	{
		Cur_Enable_M_Car = 1;
	}
}
...
/**************************两车距离**********************************/	
	TX_TAB_f[1] = distance_s / 100;
	TX_TAB_f[2] = distance_s % 100;
